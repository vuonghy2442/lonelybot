...
A more detailed description of the method is in [docs/method.md](docs/method.md), and the notes for the in-progress macro (commitment) formalization are in [docs/macro_formalization.md](docs/macro_formalization.md). The soundness argumentation lives in [docs/no_pile_to_pile.md](docs/no_pile_to_pile.md) (move-set restriction), [docs/pruning_dominance_interaction.md](docs/pruning_dominance_interaction.md) (filter composition), and [docs/last_draw_rules.md](docs/last_draw_rules.md) (streak rules), with the per-claim rigor status tracked in [docs/soundness_ledger.md](docs/soundness_ledger.md).